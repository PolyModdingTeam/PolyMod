...
public class Mod
{
    ...
    /// <param name="bytes">The content of the file as a byte array.</param>
    ...
    /// <param name="status">The loading status of the mod.</param>
    /// <param name="files">The files included in the mod.</param>
